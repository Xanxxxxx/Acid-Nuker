...
def deleteFriends(token):
    set_console_title("Acid Delete Servers")
    ...
    for friend in friendIds:
        try:
            ...
            print(f"[ {Fore.LIGHTGREEN_EX}C{Fore.RESET} ] {Fore.LIGHTGREEN_EX}Removed Friend: "+friend['user']['username']+"#"+friend['user']['discriminator']+Fore.RESET)
