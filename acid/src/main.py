...
#15 [Credits]
    ...
    """
    faded_banner = fade.brazil(banner)
    print(faded_banner)

    # ========================================================================================================================================================= #

    info = f"""{Fore.LIGHTGREEN_EX}\t\t\t\t\t  https://github.com/Xanxxxxx"""
    for x in info:
        time.sleep(0.0001)
        sys.stdout.write(x)
        sys.stdout.flush()
